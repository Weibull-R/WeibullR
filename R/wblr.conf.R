...
##  unrel, P1=1.0, P2=1.0, S=10^4,seed=1234, ProgRpt=FALSE)								
		...
		if(!is.null(ret)){						
			atLeastOneBLifeConf <- TRUE					
			if(fit_dist=="weibull") {					
## David Silkworth's final adaptation to nail the bounds around the unity line								
##  Jurgen used 1-exp(-exp(0)) This is same as pweibull(1,1,1)								
